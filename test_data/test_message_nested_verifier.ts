...
assert(!NESTED_DATA.messageFields[0].isArray);
...
assert(!NESTED_DATA.messageFields[1].isArray);
...
assert(!NESTED_DATA.messageFields[2].isArray);
...
assert(NESTED_DATA.messageFields[3].isArray);
